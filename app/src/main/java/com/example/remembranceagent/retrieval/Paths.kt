...
val indexPath: Path = File(Environment.getExternalStorageDirectory().path, "index").toPath()
val tempIndexPath: Path = File(Environment.getExternalStorageDirectory().path, "index_temp").toPath()
